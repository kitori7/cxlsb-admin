<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="user_id,title,content,excerpt,article_status,comment_status,avatar,publish_date,last_modify_date" :where="where" page-data="replace"
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/cxlsb-u-articles.js';
